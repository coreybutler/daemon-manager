...
var controller = function(config){
  ...
  config = config || {};
console.log('------------------------------------->',config.hasOwnProperty('abortOnError'));
...
//        });
        ...
        this.child.on('message',function(msg){
          /**
           * @event message
           * Fired when a message is received by the script.
           * @param {Any} message
           * The message/object sent to the script. 
           */
//          me.emit('message',msg);
        });
...
console.log(me.abortOnError,code)   
